...
export async function evidenceView(data, wiki) {
  ...
  for (const m of data.messages || []) {
    const url =
      queryLink(base, { kind: data.kind, offset: data.offset }) +
      "#" +
